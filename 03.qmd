...
* A contração é, de certa forma, a operação inversa do produto exterior $\wedge$, mas apenas no contexto do produto escalar.^[Em um apêndice, Dorst mostra que a contração é a [adjunção]{.hl} do produto exteriorem relação ao produto escalar.]
...
* Para calcular a [interseção de dois planos]{.hl}:
